...
<script src="{{asset('assets/admin/ckfinder_php/ckfinder/ckfinder.js')}}"></script>
<script src="{{asset('assets/admin/ckeditor5-31.0.0-1aoghr5i3jfd/build/ckeditor.js')}}"></script>
<script>
   ClassicEditor
